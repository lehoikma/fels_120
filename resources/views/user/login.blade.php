...
@section('title',trans('user/titles.login'))
@section('content')
    <div id="loginbox" class="mainbox col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
        ...
        <div class="panel panel-default" >
            <div class="panel-heading">
                <div class="panel-title text-center">{{trans('user/titles.login')}}</div>
            </div>
            <div class="panel-body" >
                ...
                <form name="form" id="form" class="form-horizontal" method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="register col-xs-12 controls">
                            <a href="{{asset('user/register')}}">Register a new membership</a>
                        </div>
                    </div>
                </form>
